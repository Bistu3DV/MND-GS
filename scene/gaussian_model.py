...
class GaussianModel:
    ...
    def add_densification_stats(self, viewspace_point_tensor, viewspace_point_tensor_abs, update_filter):
        self.xyz_gradient_accum[update_filter] = self.xyz_gradient_accum[update_filter] + torch.norm(viewspace_point_tensor.grad[update_filter,:2], dim=-1, keepdim=True)
        self.xyz_gradient_accum_abs[update_filter] = self.xyz_gradient_accum_abs[update_filter] + torch.norm(viewspace_point_tensor_abs.grad[update_filter,:2], dim=-1, keepdim=True)
        self.denom[update_filter] = self.denom[update_filter] + 1
        self.denom_abs[update_filter] = self.denom_abs[update_filter] + 1
